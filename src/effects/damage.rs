...
use crate::components::{
    Attributes, Confusion, DamageOverTime, Duration, EquipmentChanged, Name, Player, Pools, SerializeMe, Slow,
    StatusEffect,
};
                    ...
                    for i in 0..10 {
                        if player_pos.y - i > 1 {
                            add_effect(
                                ...
                                Targets::Tile {
                                    tile_idx: ecs.fetch_mut::<Map>().xy_idx(player_pos.x, player_pos.y - i) as i32,
                                },
                            );
                        }
                    }
